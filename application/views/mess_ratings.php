    ...
    <script>
        function sortList() {
            ...
            items.sort((a, b) => {
                ...
                if (ratingA === 'N/A' && ratingB !== 'N/A') return 1;
                if (ratingB === 'N/A' && ratingA !== 'N/A') return -1;
            ...
            items.forEach((item, index) => {
                ...
                // Update rank classes
                rankDiv.classList.remove('gold', 'silver', 'bronze');
                if (index === 0) rankDiv.classList.add('gold');
                else if (index === 1) rankDiv.classList.add('silver');
                else if (index === 2) rankDiv.classList.add('bronze');
            });
        }
        ...
        function filterList() {
            ...
            for (let i = 0; i < items.length; i++) {
                ...
                const display = name.innerText.toLowerCase().includes(filter) ? '' : 'none';
