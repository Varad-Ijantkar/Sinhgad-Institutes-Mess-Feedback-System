...
<style>
	...
	.center-align button:hover, .view-btn:hover {
...
>>>>>>> Stashed changes
		...
		document.addEventListener("DOMContentLoaded", () => {
			...
			// Example: Simulating sidebar open/close
			...
			// Replace this with your actual sidebar toggle event
			document.addEventListener("keydown", (event) => {
				if (event.key === "s") { // Press "s" to simulate sidebar toggle
					toggleSidebar();
				}
			});
		});
