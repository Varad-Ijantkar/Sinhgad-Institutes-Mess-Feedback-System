...
=======
		...
		.dashboard-content {
			...
			width: calc(100% - 200px); /* Matches sidebar width when open */
			margin-left: 200px;
			min-height: 100vh;
...
<body>
<!-- Assuming navbar is included before this content -->
<div class="dashboard-content">
	...
	<div class="card-container">
		...
		<div class="card resolved">
			...
			<div class="card-content">
				<h2>Resolved</h2>
				<p class="card-value"><?php echo $resolved_count; ?></p>
		...
		<div class="card total">
			...
			<div class="card-content">
				<h2>Total</h2>
				<p class="card-value"><?php echo $total_count; ?></p>
...
<script>
	document.addEventListener('DOMContentLoaded', function() {
		// Sync with navbar's toggleSidebar function
		...
		// Initial state check and resize handling
